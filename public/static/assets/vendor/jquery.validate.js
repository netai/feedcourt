...
$.extend($.validator, {
	...
	messages: {
		...
		accept: $.validator.format("Please select only {0} file."),
	},
	...
	classRuleSettings: {
		...
		accept:{accept:"png|jpeg|jpg|gif"},
	},
	...
	methods: {
		...
		accept: function(value, element,param) {
			var flag=false;
			var ext=param.split(',');
			var file_ext=value.toLowerCase().split('.');
			for(var i = 0; i < ext.length; i++) {
			if(ext[i].trim() == file_ext[file_ext.length-1]){
				flag=true;
				break;
			}
			}
